 ...
 */
exports.ActivitySchema.statics.getGitHubURLs = function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, this.find({ url: { $regex: patterns_json_1.default.githubURL } }, ['url']).exec().then(function (activity) { return Promise.resolve(activity.map(function (o) { return o.url; })); })];
        });
    });
};
var Activity = mongoose_1.default.model('Activity', exports.ActivitySchema, 'activity');
